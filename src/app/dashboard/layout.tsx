        ...
        <div className="mt-auto space-y-4">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-xl">
            ...
            <p className="mt-3 text-sm text-blue-100/80">
              Gerencie usuários, planos e
              operações financeiras.
            </p>
          </div>

          {/* LOGOUT */}
          <button className="flex w-full items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-4 py-4 font-medium text-white transition hover:bg-white/20">
            <LogOut size={18} />
            Sair da conta
          </button>
        </div>
