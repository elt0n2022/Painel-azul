      ...
      <section className="flex w-full items-center justify-center p-6 lg:w-1/2">
        <div className="w-full max-w-lg rounded-[32px] bg-white p-8 shadow-[0_10px_40px_rgba(0,0,0,0.08)] xl:p-10">
          ...
          <div className="mb-8 text-center lg:hidden">
            <h1 className="text-3xl font-bold text-[#1D3567]">
              AZUL FINANÇAS
            </h1>
          </div>
          ...
          {/* Header */}
          <div>
            <h2 className="text-4xl font-bold text-[#1D3567]">
              Bem-vindo
            </h2>
          ...
          <form className="mt-8 space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-200 px-4 py-4 focus-within:border-[#2C5292]">
                <Mail
                  size={20}
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <button
                type="button"
                className="font-medium text-[#2C5292] hover:underline"
              >
                Esqueceu sua senha?
              </button>
            </div>
            ...
            <button
              type="submit"
              className="w-full rounded-2xl bg-gradient-to-r from-[#1D3567] to-[#2C5292] py-4 text-base font-semibold text-white transition hover:opacity-90"
            >
              Entrar
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            ...
            <span className="font-semibold text-[#2C5292]">
